        ...
        <main id="main">            
            <section class="data_table_section result_table_section">
                ...
                <div class="btn_wrap result_btn_wrap">
                    <a href="polymorphic_add"><button class="new_btn same_btn">새 분자표지맵 그리기</button></a>
                </div>
            </section>
        </main>
    </div>
			...
			$.ajax(
			{
				...
				success : function(result)
				{
					...
					list_grid.on('click', (ev) => {
						...
						//{
							location.href = "/digit/polymorphic_detail?outcome_id=" + list_grid.getRow(ev.rowKey).outcome_id;
						//}
					});
				}
			});
